...
exports.NO_PIECE_CAN_MOVE_TO                = 'No %s can move to %s.';
exports.NO_PIECE_CAN_MOVE_TO_DISAMBIGUATION = 'No %s on the specified rank/file can move to %s.';
exports.REQUIRE_DISAMBIGUATION              = 'Cannot determine uniquely which %s is supposed to move to %s.';
exports.WRONG_DISAMBIGUATION_SYMBOL         = 'Wrong disambiguation symbol (expected: `%s`, observed: `%s`).';
exports.TRYING_TO_CAPTURE_YOUR_OWN_PIECES   = 'Capturing its own pieces is not legal.';
exports.INVALID_PIECE_SYMBOL                = 'Character `%s` is not a valid piece symbol.';
exports.INVALID_PIECE_SYMBOL_COLOR          = 'Invalid color for piece symbol `%s`.';
...
exports.INVALID_PROMOTED_PIECE              = '%s cannot be specified as a promoted piece.';
...
exports.WRONG_CHECK_CHECKMATE_SYMBOL        = 'Wrong check/checkmate symbol (expected: `%s`, observed: `%s`).';

// PGN parsing error messages
exports.INVALID_PGN_TOKEN               = 'Unrecognized character or group of characters.';
exports.INVALID_MOVE_IN_PGN_TEXT        = 'Invalid move (%s). %s';
exports.INVALID_FEN_IN_PGN_TEXT         = 'Invalid FEN string in the initial position header. %s';
...
exports.INVALID_GAME_INDEX              = 'Game index %s is invalid (only %s game(s) found in the PGN data).';
exports.UNKNOWN_VARIANT                 = 'Unknown chess game variant (%s).';
